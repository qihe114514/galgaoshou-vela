...
test('batches text reveal and keeps scroll-based background motion active', () => {
  ...
  assert.match(detail, /const travel = 308[\s\S]*scrollBackground\('bg-horizontal-scroll'/)
  assert.match(detail, /const travel = 8[\s\S]*scrollBackground\('bg-vertical-scroll'/)
