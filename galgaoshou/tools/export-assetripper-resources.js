...
function target(kind) {
  ...
  if (kind === 'stage') return { width: 138, height: 358, fit: 'contain', background: { r: 0, g: 0, b: 0, alpha: 0 } }
  if (kind === 'standee') return { width: 192, height: 490, fit: 'contain', background: { r: 0, g: 0, b: 0, alpha: 0 } }
  ...
  if (kind === 'overlay') return { width: 192, height: 315, fit: 'contain', background: { r: 0, g: 0, b: 0, alpha: 0 } }
  return { width: 192, height: 490, fit: 'contain', background: { r: 0, g: 0, b: 0, alpha: 0 } }
}
...
async function exportAsset(assetPath, kind, output) {
  ...
  if (offset) {
    ...
    outputImage = sharp({ create: { width: 192, height: 490, channels: 4, background: { r: 0, g: 0, b: 0, alpha: 0 } } })
