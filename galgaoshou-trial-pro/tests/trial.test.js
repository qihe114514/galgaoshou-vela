...
test('matches the REDMI Watch 5 216x257 reader and page layouts', () => {
  assert.match(detail, /\.page \{ width: 216px; height: 257px;/)
  assert.match(detail, /\.background-scroll[^}]*width: 216px; height: 257px;/)
  assert.match(detail, /\.dialogue-panel \{ top: 166px; width: 216px; height: 91px;/)
  assert.match(detail, /\.trial-label \{ top: 168px;/)
  assert.match(home, /src="\/common\/home-pro\.png"/)
  assert.ok(fs.existsSync('src/common/home-pro.png'))
  assert.match(home, /\.home-logo \{ top: 14px; left: 28px; width: 160px; height: 90px;/)
  assert.match(home, /\.home-panel \{ top: 106px; width: 216px; height: 151px;/)
  for (const page of [end, settings, about]) assert.match(page, /\.page \{ width: 216px; height: 257px;/)
})
